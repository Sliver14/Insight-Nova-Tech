...
"[project]/app/api/project-inquiry/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const { firstName, lastName, email, company, phone, budget, projectType, message } = body;
        // Basic validation
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseServer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseServer"].from('project_inquiries').insert({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f3023647._.js.map