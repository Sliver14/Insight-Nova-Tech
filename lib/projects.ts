...
export const projectsData = [
  ...
  description:
    "A structured finance education platform designed to help young people gain clarity, build habits, and take real financial action.",
  category: "FinTech / Financial Education",
  projectType: "Finance Education Platform",
  overview:
    "MoneySense combines guided lessons, practical workbook exercises, and community accountability to help students and young professionals move from financial confusion to confident decision-making.",
  impact: [
